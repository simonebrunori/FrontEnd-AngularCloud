(function ($) {
  ...
  $.AdminBSB.panel = {
    ...
    closeIcon: function () {
      var configs = $.AdminBSB.options.panel;
      var $anchor = $('<a>').attr('href', 'javascript:void(0);').addClass('panel-close');
    ...
    //   var configs = $.AdminBSB.options.panel;
    //   var $anchor = $('<a>').attr('href', 'javascript:void(0);').addClass('panel-collapsable');
    //   if (configs.tooltip.show) {
    //     $anchor.attr({
    //       'data-toggle': 'tooltip',
    ...
    fullscreenIcon: function () {
      var configs = $.AdminBSB.options.panel;
      var $anchor = $('<a>').attr('href', 'javascript:void(0);').addClass('panel-fullscreen');
      if (configs.tooltip.show) {
        $anchor.attr({
          'data-toggle': 'tooltip',
